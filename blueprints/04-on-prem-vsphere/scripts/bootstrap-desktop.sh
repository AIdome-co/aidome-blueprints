...
#
# Usage:
#   sudo bash bootstrap-desktop.sh --ssh-key "ssh-ed25519 AAAA..." --allowed-ssh-cidr 10.0.0.0/8
#   sudo bash bootstrap-desktop.sh --ssh-key-file /path/to/key.pub --allowed-ssh-cidr 192.168.1.0/24 --hostname myhost --reboot
#
# Requirements:
...
Example:
  sudo bash $(basename "$0") --ssh-key "ssh-ed25519 AAAA..." --allowed-ssh-cidr 10.0.0.0/8 --hostname aidome-lab --reboot
EOF
  exit 0
}
