...
```hcl
module "dev_vm" {
  source = "./blueprints/05-dev-vm-aws/terraform"
...
aws cloudformation deploy \
  --template-file blueprints/05-dev-vm-aws/cloudformation/ec2-dev.yaml \
  --stack-name aidome-dev-vm \
  --parameter-overrides \
      VpcId=vpc-xxxxxxxx \
